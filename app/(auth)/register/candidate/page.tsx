                ...
                <CardContent className="p-8">
                    ...
                    <div className="mb-6">
                        <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#194d8e]/10">
                            <User size={24} className="text-[#194d8e]" />
                        </div>
                        <h2 className="text-2xl font-bold text-gray-900">Đăng ký Ứng viên</h2>
                        <p className="mt-1 text-sm text-gray-500">Tạo tài khoản để tìm kiếm việc làm IT</p>
                    </div>
